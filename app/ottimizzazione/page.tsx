...
const PRESETS = [
    {
        label: "Ottimizza costi e percorsi",
        icon: TrendingUp,
        query:
            "Analizza le assegnazioni attuali e suggerisci come ridurre i costi operativi mantenendo la piena conformita normativa. Considera: ottimizzazione rotte, abbinamento autista-veicolo-viaggio, riduzione km a vuoto, e pianificazione pause obbligatorie lungo il percorso. Stima il risparmio potenziale.",
    },
    {
        label: "Pianifica settimana",
        icon: Target,
        query:
            "Pianifica la distribuzione dei viaggi per la settimana considerando: disponibilita autisti, ore di guida residue (giornaliere/settimanali/bisettimanali CE 561/2006), validita documenti, disponibilita veicoli, requisiti ADR, e obblighi di riposo settimanale. Ottimizza per efficienza e costi.",
    },
    {
        label: "Assegna autisti ottimale",
        icon: Users,
        query:
            "Analizza i viaggi pianificati e suggerisci la migliore assegnazione degli autisti disponibili ottimizzando per efficienza e costi. Per ogni assegnazione VERIFICA: ore di guida residue sufficienti, documenti validi alla data del viaggio, certificato ADR se richiesto, scarico tachigrafo in regola.",
    },
    {
...
export default function OttimizzazionePage() {
    ...
    return (
        <MainLayout title="Ottimizzazione AI">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h2 className="text-xl font-bold text-foreground">Ottimizzazione AI</h2>
                                <p className="text-xs text-muted-foreground">
                                    Ottimizzazione intelligente percorsi, flotta e autisti
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="lg:col-span-1 space-y-4">
                                                    ...
                                                    <div className="flex items-center gap-2">
                                                        <div
                                                            className={cn(
                                                                ...
                                                                d.isAvailable ? "bg-emerald-500" : "bg-red-500"
                                                            )}
                                                        />
                                                        ...
                                                        {d.adrCertificate && (
                                                            <span className="px-1 py-0.5 rounded text-[9px] font-bold bg-orange-500/15 text-orange-600 border border-orange-500/15">
                                                                ADR
                                                            </span>
                                                        )}
                                                    </div>
                                                ...
                                                >
                                                    <div className="flex items-center gap-2">
                                                        <div
                                                            className={cn(
                                                                "w-1.5 h-1.5 rounded-full",
                                                                v.isAvailable ? "bg-sky-400" : "bg-red-500"
                                                            )}
                                                        />
                        ...
                        <div className="glass rounded-xl p-4 space-y-2">
                            ...
                            {[
                                ...
                                { label: "Veicoli disponibili", value: availableVehicles.length, color: "text-sky-600" },
                                {
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        ...
                        {error && (
                            <div className="glass rounded-xl overflow-hidden border border-red-500/25">
                                <div className="flex items-center gap-3 p-4 bg-red-500/5 border-b border-red-200">
                                    <AlertTriangle className="w-5 h-5 text-red-600 flex-shrink-0" />
                                    <div>
                                        <p className="text-sm font-semibold text-red-600">{error}</p>
                                        {errorDetails && (
                                            <p className="text-xs text-red-600/60 mt-0.5">{errorDetails}</p>
                                        )}
                                    </div>
                                </div>
